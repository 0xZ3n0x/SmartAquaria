...
// 8x8 bitmap font — public domain (based on font8x8_basic, CC0)
// Encoding: each byte is one row (top to bottom).
// Bit 0 (LSB) = leftmost pixel, bit 7 (MSB) = rightmost pixel.
// Glyphs defined for ASCII 0x20–0x7E; all other entries are blank.

constexpr std::array<std::array<uint8_t, 8>, 128> k_font8x8 =
{{
